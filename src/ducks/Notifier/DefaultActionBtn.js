...
const DefaultActionBtn = ({ className: classNameProp, classes: classesProp, onClick }) => {
  const classes = _.merge({}, useActionStyles(), classesProp)
  return (
    <IconButton classes={{ root: clsx(classNameProp, classes.root), label: classes.label }} onClick={() => { onClick() }}>
